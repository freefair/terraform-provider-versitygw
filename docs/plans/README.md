...
|---|---|---|---|---|
| 00 | [Shared S3 sub-resource client](00-shared-s3-subresource-client.md) | — | — | — |
| 01 | [Bucket policy](01-bucket-policy.md) | `versitygw_bucket_policy` | `aws_s3_bucket_policy` | 00 |
...
and a bucket. Versioning and object lock next because they are a pair. The
rest is ordered by how often it is needed.
